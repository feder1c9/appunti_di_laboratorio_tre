...
Prima di passare alla descrizione di ogni sottosistema dobbiamo introdurre alcune definizioni.
  ...
  \begin{itemize}
      ...
      \item \textbf{Science Workshop 500}: Interfaccia versatile concepita per la portabilità e l'uso sul campo. Dispone di 2 canali digitali e 3 canali analogici. Utilizza una connessione tramite porta seriale (50 kHz), potendo raggiungere picchi di 20 kHz in \textit{burst mode} sui canali analogici. La sua natura portatile è garantita da un buffer interno da 50 KB e dall'alimentazione tramite batterie AA; la velocità di trasferimento dati verso il PC è stata successivamente ottimizzata tramite l'impiego di adattatori USB/Seriale dedicati.
  \end{itemize}
